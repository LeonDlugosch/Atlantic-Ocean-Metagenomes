...
path = paste(path, "/06_TabularFiles/fna/", sep = "")
...
for (i in 1:length(file.names)) {
  ...
  print(paste("Reading ", Sample, ".fna ...", sep = ""), quote = F)
  ...
  complete = grepl(fasta.tab$ID, pattern = "partial=00")
  ...
  file = paste(Sample, "_FR.fna", sep = "")
  file.c = paste(Sample, "_FR_complete.fna", sep = "")
